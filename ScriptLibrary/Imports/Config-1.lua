local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/ProxColdAirPublishing/UIs/main/ScriptLibrary/Master.lua"))();
local window = library:CreateWindow("Expect's Script Library")
